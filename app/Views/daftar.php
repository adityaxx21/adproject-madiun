...
<body class="bg-gradient-success sidebar-toggled">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block ">
                                <div style=" height:600; ">
                                    ...
                                    <img height="100%" src="http://localhost:8080/img/Lambang_Kota_Madiun.png" alt="">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Selamat Datang Di E-PBB Kota Madiun</h1>
                                    </div>
                                    <form class="user">
